...
# funçao conexão com o banco e transformando a consulta em um DataFrame
...
# função para padronizar na mesma escala variaveis numericas
...
#função para codificação variaveis categoricas
def save_encoders(df, nome_colunas):
 ...
 #função para carregar os objetos scalers via API
...
#função para carregar os objetos encoders via API
